...
function App() {
  ...
  // ======================================================
  // API REQUEST
  // SESUAI DENGAN SERVER BOT DINSTORE PORT 3061
  // ======================================================
  ...
  const loadStatus = async () => {
    try {
      ...
      // SERVER HARUS BENAR-BENAR ONLINE
      const apiOnline =
        data?.success === true &&
        data?.server === "online";

      setServerOnline(apiOnline);
      ...
      // KALAU API PORT 3061 MATI / TIDAK BISA DIAKSES
      // WEBSITE JUGA MENJADI OFFLINE
  ...
  const startPairing = async () => {
    if (!serverOnline) {
      showMessage("Server API sedang offline.");
      return;
    }
    ...
    try {
      ...
      const data = await apiRequest("/api/pair", {
        method: "POST",
        headers: {
      ...
      showMessage(
        error?.name === "AbortError"
          ? "Server API terlalu lama merespons."
  ...
  const copyPairingCode = async () => {
    ...
    try {
      ...
      showMessage("Gagal menyalin kode.");
    }
  };
    ...
    <div className="app-container">
      ...
      <main className="main-content-mobile">
        ...
        {page === "dashboard" && (
          <div className="page-content">
            ...
            <div className="hero-gradient-card">
              ...
              <p>
                Hubungkan perangkat WhatsApp, lihat kode pairing, dan kelola semua session dari satu tempat.
              </p>
        ...
        {page === "pairing" && (
          <div className="page-content">
            ...
            <div className="header-title-box">
              ...
              <p>
                Masukkan nomor WhatsApp untuk mendapatkan kode pairing.
              </p>
            </div>
            ...
            <div className="card-box pairing-card-box">
              ...
              <div className="step-row">
                ...
                <div>
                  ...
                  <p>
                    Gunakan nomor WhatsApp yang aktif untuk dihubungkan.
                  </p>
                </div>
              </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <li>
                          Masukkan kode di atas untuk menghubungkan bot.
                        </li>
                      </ol>
                    </div>
        ...
        {page === "sessions" && (
          <div className="page-content">
            ...
            <div className="header-title-box">
              ...
              <p>
                Daftar perangkat sesi WhatsApp yang terhubung.
              </p>
            </div>
            ...
            >
              ...
              {sessions.length === 0 ? (
                ...
                >
                  ...
                  >
                    Belum ada sesi aktif. Lakukan pairing terlebih dahulu.
                  </p>
                </div>
              ) : (
                sessions.map(
            ...
            {logoutTarget && (
              ...
              >
                ...
                >
                  ...
                  >
                    Masukkan nomor WhatsApp lengkap yang terdaftar pada sesi ini untuk konfirmasi.
                  </p>
        ...
        <footer className="app-footer">
          <p>
            © 2026 <b>SIBOT</b>. All Rights Reserved.
          </p>
